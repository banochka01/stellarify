...
const LINES = [
  "Ночь собирает свет в карманы,",
  "и город тише на полтона.",
  "Мы держим волну на границе сна —",
  "она ведёт, и очередь верна.",
  "Строка за нотой поспевает,",
  "ни одной не пропуская.",
  "А если скажешь «спокойнее» —",
  "волна подстроится. Ей можно верить."
];
